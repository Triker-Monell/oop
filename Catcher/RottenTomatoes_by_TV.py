...
def work():
    try:
        f = open('/tmp/infocollection/data/RottenTomatoes_by_TV.txt', 'r')
        content=f.read()
        name=content[0:-2]
        ...
        if f:
            f.close()
            w = open('/tmp/infocollection/data/RottenTomatoes_by_TV.txt', 'w')
            w.truncate()
            w.close()
        ...
        for movie in movie_list:   
            ...
            save_file(text, '/tmp/infocollection/data/RottenTomatoes_by_TV.txt')
