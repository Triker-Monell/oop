...
IMDBSWidget::IMDBSWidget(const Score *_score, QWidget *parent):
    ScoreWidget(parent),imdbscore(dynamic_cast<const IMDBScore*>(_score))
{
    ...
    scorelabel=new QLabel(QString::number(imdbscore->getScore()),parent);
